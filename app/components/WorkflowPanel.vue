...
<template>
  <div class="flex flex-col items-center justify-center h-full w-full rounded-2xl bg-elevated">
    <div class="flex flex-col items-center gap-5 max-w-sm text-center px-6">
      ...
      <div class="space-y-1.5">
        <p class="text-lg font-semibold text-default">{{ workflowTitle ?? 'Workflow' }}</p>
        <p class="text-sm text-dimmed leading-relaxed">Build and run automation workflows with Gaia's browser agent.</p>
      </div>
